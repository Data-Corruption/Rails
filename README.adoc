...
|EXIT |This stops the program's execution and resets the program counter. It is replaced by JMPL r0, r0. This should put the cpu in a state where it's ready to be started again.
|====
